				...
				<div class="absolute inset-0 overflow-hidden">
					<div
						...
						<TransitionChild
							...
							<DialogPanel
								class="pointer-events-auto relative w-screen md:max-w-xl">
								<div
									class="flex h-full flex-col gap-4 overflow-y-auto bg-base-200 text-neutral">
									<div
										class="flex items-center justify-between gap-2 p-2 md:p-4">
