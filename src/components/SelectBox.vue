...
<template>
	<Listbox v-model="selectedElement" @update:modelValue="value => emit('update', value)">
		<div class="relative">
			<ListboxButton
				class="flex w-full cursor-default justify-between gap-1 rounded-md bg-base-100 p-3 text-left text-sm shadow-md focus:outline-none">
			...
			<Transition enterActiveClass="transition duration-200 ease-out"
				...
				<ListboxOptions class="absolute z-10 mt-2 w-full min-w-fit overflow-auto rounded-md bg-base-100 text-sm shadow-lg">
